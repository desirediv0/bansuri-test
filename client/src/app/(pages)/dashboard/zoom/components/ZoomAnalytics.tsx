...
export default function ZoomAnalytics({ analyticsData }: ZoomAnalyticsProps) {
    ...
    const monthlyRevenueData = Object.entries(analyticsData.monthlyRevenue || {}).map(
            ...
            <Tabs defaultValue="summary" value={activeTab} onValueChange={setActiveTab}>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-3xl font-bold">{analyticsData.activeSubscriptions}</p>
                                    </div>
                                </div>
                                <div>
                ...
                <TabsContent value="popular" className="space-y-4">
                    <Card>
                        ...
                        <CardContent>
                            {analyticsData.sessionPopularity && analyticsData.sessionPopularity.length > 0 ? (
                                <Table>
                                    <TableHeader>
                                        <TableRow>
                                    ...
                                    <TableBody>
                                        {analyticsData.sessionPopularity.map((session) => (
                                            <TableRow key={session.id}>
                                                ...
                                                <TableCell className="text-center">{session.subscriberCount}</TableCell>
                                                <TableCell className="text-center">
                                                    <span className={`px-2 py-1 rounded text-xs ${session.isActive
                                    ...
                                    <TableBody>
                                        {analyticsData.recentPayments.map((payment) => (
                                            <TableRow key={payment.id}>
                                                ...
                                                <TableCell>{payment.subscription.zoomSession.title}</TableCell>
